...
#' @docType class
#' @title TeamStatsGame
#' @description TeamStatsGame Class
...
TeamStatsGame <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new TeamStatsGame class.
    #'
    #' @param toi toi
    #' @param season season
    ...
    #'
    #' @return TeamStatsGame as a base R list.
    #' @examples
    #' # convert array of TeamStatsGame (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert TeamStatsGame to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      TeamStatsGameObject <- list()
      if (!is.null(self$`toi`)) {
        TeamStatsGameObject[["toi"]] <-
          self$`toi`
      }
      if (!is.null(self$`gf`)) {
        TeamStatsGameObject[["gf"]] <-
          self$`gf`
      }
      if (!is.null(self$`ga`)) {
        TeamStatsGameObject[["ga"]] <-
          self$`ga`
      }
      if (!is.null(self$`gf_adj`)) {
        TeamStatsGameObject[["gf_adj"]] <-
          self$`gf_adj`
      }
      if (!is.null(self$`ga_adj`)) {
        TeamStatsGameObject[["ga_adj"]] <-
          self$`ga_adj`
      }
      if (!is.null(self$`hdgf`)) {
        TeamStatsGameObject[["hdgf"]] <-
          self$`hdgf`
      }
      if (!is.null(self$`hdga`)) {
        TeamStatsGameObject[["hdga"]] <-
          self$`hdga`
      }
      if (!is.null(self$`base_xgf`)) {
        TeamStatsGameObject[["base_xgf"]] <-
          self$`base_xgf`
      }
      if (!is.null(self$`base_xga`)) {
        TeamStatsGameObject[["base_xga"]] <-
          self$`base_xga`
      }
      if (!is.null(self$`base_xgf_adj`)) {
        TeamStatsGameObject[["base_xgf_adj"]] <-
          self$`base_xgf_adj`
      }
      if (!is.null(self$`base_xga_adj`)) {
        TeamStatsGameObject[["base_xga_adj"]] <-
          self$`base_xga_adj`
      }
      if (!is.null(self$`context_xgf`)) {
        TeamStatsGameObject[["context_xgf"]] <-
          self$`context_xgf`
      }
      if (!is.null(self$`context_xga`)) {
        TeamStatsGameObject[["context_xga"]] <-
          self$`context_xga`
      }
      if (!is.null(self$`context_xgf_adj`)) {
        TeamStatsGameObject[["context_xgf_adj"]] <-
          self$`context_xgf_adj`
      }
      if (!is.null(self$`context_xga_adj`)) {
        TeamStatsGameObject[["context_xga_adj"]] <-
          self$`context_xga_adj`
      }
      if (!is.null(self$`xgf`)) {
        TeamStatsGameObject[["xgf"]] <-
          self$`xgf`
      }
      if (!is.null(self$`xga`)) {
        TeamStatsGameObject[["xga"]] <-
          self$`xga`
      }
      if (!is.null(self$`xgf_adj`)) {
        TeamStatsGameObject[["xgf_adj"]] <-
          self$`xgf_adj`
      }
      if (!is.null(self$`xga_adj`)) {
        TeamStatsGameObject[["xga_adj"]] <-
          self$`xga_adj`
      }
      if (!is.null(self$`sf`)) {
        TeamStatsGameObject[["sf"]] <-
          self$`sf`
      }
      if (!is.null(self$`sa`)) {
        TeamStatsGameObject[["sa"]] <-
          self$`sa`
      }
      if (!is.null(self$`sf_adj`)) {
        TeamStatsGameObject[["sf_adj"]] <-
          self$`sf_adj`
      }
      if (!is.null(self$`sa_adj`)) {
        TeamStatsGameObject[["sa_adj"]] <-
          self$`sa_adj`
      }
      if (!is.null(self$`hdsf`)) {
        TeamStatsGameObject[["hdsf"]] <-
          self$`hdsf`
      }
      if (!is.null(self$`hdsa`)) {
        TeamStatsGameObject[["hdsa"]] <-
          self$`hdsa`
      }
      if (!is.null(self$`ff`)) {
        TeamStatsGameObject[["ff"]] <-
          self$`ff`
      }
      if (!is.null(self$`fa`)) {
        TeamStatsGameObject[["fa"]] <-
          self$`fa`
      }
      if (!is.null(self$`ff_adj`)) {
        TeamStatsGameObject[["ff_adj"]] <-
          self$`ff_adj`
      }
      if (!is.null(self$`fa_adj`)) {
        TeamStatsGameObject[["fa_adj"]] <-
          self$`fa_adj`
      }
      if (!is.null(self$`hdff`)) {
        TeamStatsGameObject[["hdff"]] <-
          self$`hdff`
      }
      if (!is.null(self$`hdfa`)) {
        TeamStatsGameObject[["hdfa"]] <-
          self$`hdfa`
      }
      if (!is.null(self$`cf`)) {
        TeamStatsGameObject[["cf"]] <-
          self$`cf`
      }
      if (!is.null(self$`ca`)) {
        TeamStatsGameObject[["ca"]] <-
          self$`ca`
      }
      if (!is.null(self$`cf_adj`)) {
        TeamStatsGameObject[["cf_adj"]] <-
          self$`cf_adj`
      }
      if (!is.null(self$`ca_adj`)) {
        TeamStatsGameObject[["ca_adj"]] <-
          self$`ca_adj`
      }
      if (!is.null(self$`bsf`)) {
        TeamStatsGameObject[["bsf"]] <-
          self$`bsf`
      }
      if (!is.null(self$`bsa`)) {
        TeamStatsGameObject[["bsa"]] <-
          self$`bsa`
      }
      if (!is.null(self$`bsf_adj`)) {
        TeamStatsGameObject[["bsf_adj"]] <-
          self$`bsf_adj`
      }
      if (!is.null(self$`bsa_adj`)) {
        TeamStatsGameObject[["bsa_adj"]] <-
          self$`bsa_adj`
      }
      if (!is.null(self$`msf`)) {
        TeamStatsGameObject[["msf"]] <-
          self$`msf`
      }
      if (!is.null(self$`msa`)) {
        TeamStatsGameObject[["msa"]] <-
          self$`msa`
      }
      if (!is.null(self$`msf_adj`)) {
        TeamStatsGameObject[["msf_adj"]] <-
          self$`msf_adj`
      }
      if (!is.null(self$`msa_adj`)) {
        TeamStatsGameObject[["msa_adj"]] <-
          self$`msa_adj`
      }
      if (!is.null(self$`hdmsf`)) {
        TeamStatsGameObject[["hdmsf"]] <-
          self$`hdmsf`
      }
      if (!is.null(self$`hdmsa`)) {
        TeamStatsGameObject[["hdmsa"]] <-
          self$`hdmsa`
      }
      if (!is.null(self$`teammate_block`)) {
        TeamStatsGameObject[["teammate_block"]] <-
          self$`teammate_block`
      }
      if (!is.null(self$`teammate_block_adj`)) {
        TeamStatsGameObject[["teammate_block_adj"]] <-
          self$`teammate_block_adj`
      }
      if (!is.null(self$`hf`)) {
        TeamStatsGameObject[["hf"]] <-
          self$`hf`
      }
      if (!is.null(self$`ht`)) {
        TeamStatsGameObject[["ht"]] <-
          self$`ht`
      }
      if (!is.null(self$`ozf`)) {
        TeamStatsGameObject[["ozf"]] <-
          self$`ozf`
      }
      if (!is.null(self$`nzf`)) {
        TeamStatsGameObject[["nzf"]] <-
          self$`nzf`
      }
      if (!is.null(self$`dzf`)) {
        TeamStatsGameObject[["dzf"]] <-
          self$`dzf`
      }
      if (!is.null(self$`fow`)) {
        TeamStatsGameObject[["fow"]] <-
          self$`fow`
      }
      if (!is.null(self$`fol`)) {
        TeamStatsGameObject[["fol"]] <-
          self$`fol`
      }
      if (!is.null(self$`ozfw`)) {
        TeamStatsGameObject[["ozfw"]] <-
          self$`ozfw`
      }
      if (!is.null(self$`ozfl`)) {
        TeamStatsGameObject[["ozfl"]] <-
          self$`ozfl`
      }
      if (!is.null(self$`nzfw`)) {
        TeamStatsGameObject[["nzfw"]] <-
          self$`nzfw`
      }
      if (!is.null(self$`nzfl`)) {
        TeamStatsGameObject[["nzfl"]] <-
          self$`nzfl`
      }
      if (!is.null(self$`dzfw`)) {
        TeamStatsGameObject[["dzfw"]] <-
          self$`dzfw`
      }
      if (!is.null(self$`dzfl`)) {
        TeamStatsGameObject[["dzfl"]] <-
          self$`dzfl`
      }
      if (!is.null(self$`pent0`)) {
        TeamStatsGameObject[["pent0"]] <-
          self$`pent0`
      }
      if (!is.null(self$`pent2`)) {
        TeamStatsGameObject[["pent2"]] <-
          self$`pent2`
      }
      if (!is.null(self$`pent4`)) {
        TeamStatsGameObject[["pent4"]] <-
          self$`pent4`
      }
      if (!is.null(self$`pent5`)) {
        TeamStatsGameObject[["pent5"]] <-
          self$`pent5`
      }
      if (!is.null(self$`pent10`)) {
        TeamStatsGameObject[["pent10"]] <-
          self$`pent10`
      }
      if (!is.null(self$`pend0`)) {
        TeamStatsGameObject[["pend0"]] <-
          self$`pend0`
      }
      if (!is.null(self$`pend2`)) {
        TeamStatsGameObject[["pend2"]] <-
          self$`pend2`
      }
      if (!is.null(self$`pend4`)) {
        TeamStatsGameObject[["pend4"]] <-
          self$`pend4`
      }
      if (!is.null(self$`pend5`)) {
        TeamStatsGameObject[["pend5"]] <-
          self$`pend5`
      }
      if (!is.null(self$`pend10`)) {
        TeamStatsGameObject[["pend10"]] <-
          self$`pend10`
      }
      if (!is.null(self$`season`)) {
        TeamStatsGameObject[["season"]] <-
          self$`season`
      }
      if (!is.null(self$`session`)) {
        TeamStatsGameObject[["session"]] <-
          self$`session`
      }
      if (!is.null(self$`game_id`)) {
        TeamStatsGameObject[["game_id"]] <-
          self$`game_id`
      }
      if (!is.null(self$`game_date`)) {
        TeamStatsGameObject[["game_date"]] <-
          self$`game_date`
      }
      if (!is.null(self$`team`)) {
        TeamStatsGameObject[["team"]] <-
          self$`team`
      }
      if (!is.null(self$`opp_team`)) {
        TeamStatsGameObject[["opp_team"]] <-
          self$`opp_team`
      }
      if (!is.null(self$`strength_state`)) {
        TeamStatsGameObject[["strength_state"]] <-
          self$`strength_state`
      }
      if (!is.null(self$`period`)) {
        TeamStatsGameObject[["period"]] <-
          self$`period`
      }
      if (!is.null(self$`score_state`)) {
        TeamStatsGameObject[["score_state"]] <-
          self$`score_state`
      }
      return(TeamStatsGameObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of TeamStatsGame
    #'
    #' @param input_json the JSON input
    #' @return the instance of TeamStatsGame
    ...
    #' @return TeamStatsGame in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to TeamStatsGame and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`toi`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TeamStatsGame: the required field `toi` is missing."))
      }
      ...
      if (!is.null(input_json$`season`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TeamStatsGame: the required field `season` is missing."))
      }
      ...
      if (!is.null(input_json$`session`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TeamStatsGame: the required field `session` is missing."))
      }
      ...
      if (!is.null(input_json$`game_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TeamStatsGame: the required field `game_id` is missing."))
      }
      ...
      if (!is.null(input_json$`game_date`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TeamStatsGame: the required field `game_date` is missing."))
      }
      ...
      if (!is.null(input_json$`team`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TeamStatsGame: the required field `team` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of TeamStatsGame
    toString = function() {
      self$toJSONString()
    },
...
# TeamStatsGame$unlock()
#
## Below is an example to define the print function
# TeamStatsGame$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
