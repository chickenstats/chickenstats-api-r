...
#'
#' @docType class
#' @title Shifts operations
#' @description ShiftsApi
...
#' @export
ShiftsApi <- R6::R6Class(
  "ShiftsApi",
  public = list(
    api_client = NULL,

    #' @description
    #' Initialize a new ShiftsApi.
    #'
    ...
    ReadShifts = function(season = NULL, sessions = NULL, game_id = NULL, api_id = NULL, team = NULL, period = NULL, include = NULL, limit = 10000, offset = 0, data_file = NULL, ...) {
      local_var_response <- self$ReadShiftsWithHttpInfo(season, sessions, game_id, api_id, team, period, include, limit, offset, data_file = data_file, ...)
    ...
    #' @param ... Other optional arguments
    #'
    #' @return API response (ShiftsResponse) with additional information such as HTTP status code, headers
    ReadShiftsWithHttpInfo = function(season = NULL, sessions = NULL, game_id = NULL, api_id = NULL, team = NULL, period = NULL, include = NULL, limit = 10000, offset = 0, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (`limit` > 50000) {
        stop("Invalid value for `limit` when calling ShiftsApi$ReadShifts, must be smaller than or equal to 50000.")
      }
      if (`limit` < 1) {
        stop("Invalid value for `limit` when calling ShiftsApi$ReadShifts, must be bigger than or equal to 1.")
      }

      if (`offset` < 0) {
        stop("Invalid value for `offset` when calling ShiftsApi$ReadShifts, must be bigger than or equal to 0.")
      }
      ...
      for (query_item in `sessions`) {
        ...
        if (!is.null(query_item) && !(query_item %in% c("R", "P"))) {
          stop("Invalid value for sessions when calling ShiftsApi$ReadShifts. Must be [R, P].")
        }
      ...
      for (query_item in `include`) {
        ...
        if (!is.null(query_item) && !(query_item %in% c("player", "game"))) {
          stop("Invalid value for include when calling ShiftsApi$ReadShifts. Must be [player, game].")
        }
      ...
      local_var_url_path <- "/api/v1/chicken_nhl/shifts"
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "ShiftsResponse"),
          error = function(e) {
    ...
    ReadShiftsGameIdsWithHttpInfo = function(season = NULL, sessions = NULL, limit = 10000, offset = 0, data_file = NULL, ...) {
      ...
      for (query_item in `sessions`) {
        # validate enum values
        if (!is.null(query_item) && !(query_item %in% c("R", "P"))) {
          stop("Invalid value for sessions when calling ShiftsApi$ReadShiftsGameIds. Must be [R, P].")
        }
        query_params[["sessions"]] <- c(query_params[["sessions"]], list(`sessions` = query_item))
      }
