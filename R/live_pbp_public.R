...
#' @docType class
#' @title LivePbpPublic
#' @description LivePbpPublic Class
...
LivePbpPublic <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new LivePbpPublic class.
    #'
    #' @param id id
    #' @param season season
    ...
    #'
    #' @return LivePbpPublic as a base R list.
    #' @examples
    #' # convert array of LivePbpPublic (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert LivePbpPublic to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      LivePbpPublicObject <- list()
      if (!is.null(self$`id`)) {
        LivePbpPublicObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`season`)) {
        LivePbpPublicObject[["season"]] <-
          self$`season`
      }
      if (!is.null(self$`session`)) {
        LivePbpPublicObject[["session"]] <-
          self$`session`
      }
      ...
      if (!is.null(self$`period`)) {
        LivePbpPublicObject[["period"]] <-
          self$`period`
      }
      if (!is.null(self$`period_seconds`)) {
        LivePbpPublicObject[["period_seconds"]] <-
          self$`period_seconds`
      }
      if (!is.null(self$`game_seconds`)) {
        LivePbpPublicObject[["game_seconds"]] <-
          self$`game_seconds`
      }
      if (!is.null(self$`strength_state`)) {
        LivePbpPublicObject[["strength_state"]] <-
          self$`strength_state`
      }
      if (!is.null(self$`event_team`)) {
        LivePbpPublicObject[["event_team"]] <-
          self$`event_team`
      }
      if (!is.null(self$`opp_team`)) {
        LivePbpPublicObject[["opp_team"]] <-
          self$`opp_team`
      }
      if (!is.null(self$`event`)) {
        LivePbpPublicObject[["event"]] <-
          self$`event`
      }
      if (!is.null(self$`description`)) {
        LivePbpPublicObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`zone`)) {
        LivePbpPublicObject[["zone"]] <-
          self$`zone`
      }
      if (!is.null(self$`coords_x`)) {
        LivePbpPublicObject[["coords_x"]] <-
          self$`coords_x`
      }
      if (!is.null(self$`coords_y`)) {
        LivePbpPublicObject[["coords_y"]] <-
          self$`coords_y`
      }
      if (!is.null(self$`danger`)) {
        LivePbpPublicObject[["danger"]] <-
          self$`danger`
      }
      ...
      if (!is.null(self$`score_state`)) {
        LivePbpPublicObject[["score_state"]] <-
          self$`score_state`
      }
      if (!is.null(self$`score_diff`)) {
        LivePbpPublicObject[["score_diff"]] <-
          self$`score_diff`
      }
      if (!is.null(self$`forwards_percent`)) {
        LivePbpPublicObject[["forwards_percent"]] <-
          self$`forwards_percent`
      }
      if (!is.null(self$`opp_forwards_percent`)) {
        LivePbpPublicObject[["opp_forwards_percent"]] <-
          self$`opp_forwards_percent`
      }
      if (!is.null(self$`shot_type`)) {
        LivePbpPublicObject[["shot_type"]] <-
          self$`shot_type`
      }
      if (!is.null(self$`event_length`)) {
        LivePbpPublicObject[["event_length"]] <-
          self$`event_length`
      }
      if (!is.null(self$`event_distance`)) {
        LivePbpPublicObject[["event_distance"]] <-
          self$`event_distance`
      }
      if (!is.null(self$`pbp_distance`)) {
        LivePbpPublicObject[["pbp_distance"]] <-
          self$`pbp_distance`
      }
      if (!is.null(self$`event_angle`)) {
        LivePbpPublicObject[["event_angle"]] <-
          self$`event_angle`
      }
      if (!is.null(self$`penalty`)) {
        LivePbpPublicObject[["penalty"]] <-
          self$`penalty`
      }
      if (!is.null(self$`penalty_length`)) {
        LivePbpPublicObject[["penalty_length"]] <-
          self$`penalty_length`
      }
      ...
      if (!is.null(self$`defense_count`)) {
        LivePbpPublicObject[["defense_count"]] <-
          self$`defense_count`
      }
      if (!is.null(self$`opp_strength_state`)) {
        LivePbpPublicObject[["opp_strength_state"]] <-
          self$`opp_strength_state`
      }
      if (!is.null(self$`opp_score_state`)) {
        LivePbpPublicObject[["opp_score_state"]] <-
          self$`opp_score_state`
      }
      if (!is.null(self$`opp_score_diff`)) {
        LivePbpPublicObject[["opp_score_diff"]] <-
          self$`opp_score_diff`
      }
      ...
      if (!is.null(self$`home_forwards_count`)) {
        LivePbpPublicObject[["home_forwards_count"]] <-
      ...
      if (!is.null(self$`away_forwards_count`)) {
        LivePbpPublicObject[["away_forwards_count"]] <-
      ...
      if (!is.null(self$`change_on_count`)) {
        LivePbpPublicObject[["change_on_count"]] <-
      ...
      if (!is.null(self$`change_on_defense_count`)) {
        LivePbpPublicObject[["change_on_defense_count"]] <-
      ...
      if (!is.null(self$`change_on_goalie_count`)) {
        LivePbpPublicObject[["change_on_goalie_count"]] <-
      ...
      if (!is.null(self$`base_xg`)) {
        LivePbpPublicObject[["base_xg"]] <-
          self$`base_xg`
      }
      if (!is.null(self$`base_xg_adj`)) {
        LivePbpPublicObject[["base_xg_adj"]] <-
          self$`base_xg_adj`
      }
      if (!is.null(self$`context_xg`)) {
        LivePbpPublicObject[["context_xg"]] <-
          self$`context_xg`
      }
      if (!is.null(self$`context_xg_adj`)) {
        LivePbpPublicObject[["context_xg_adj"]] <-
          self$`context_xg_adj`
      }
      if (!is.null(self$`pred_goal`)) {
        LivePbpPublicObject[["pred_goal"]] <-
          self$`pred_goal`
      }
      if (!is.null(self$`pred_goal_adj`)) {
        LivePbpPublicObject[["pred_goal_adj"]] <-
          self$`pred_goal_adj`
      }
      if (!is.null(self$`goal`)) {
        LivePbpPublicObject[["goal"]] <-
          self$`goal`
      }
      if (!is.null(self$`goal_adj`)) {
        LivePbpPublicObject[["goal_adj"]] <-
          self$`goal_adj`
      }
      if (!is.null(self$`hd_goal`)) {
        LivePbpPublicObject[["hd_goal"]] <-
          self$`hd_goal`
      }
      if (!is.null(self$`shot`)) {
        LivePbpPublicObject[["shot"]] <-
          self$`shot`
      }
      if (!is.null(self$`shot_adj`)) {
        LivePbpPublicObject[["shot_adj"]] <-
          self$`shot_adj`
      }
      if (!is.null(self$`hd_shot`)) {
        LivePbpPublicObject[["hd_shot"]] <-
          self$`hd_shot`
      }
      if (!is.null(self$`miss`)) {
        LivePbpPublicObject[["miss"]] <-
          self$`miss`
      }
      if (!is.null(self$`miss_adj`)) {
        LivePbpPublicObject[["miss_adj"]] <-
          self$`miss_adj`
      }
      if (!is.null(self$`hd_miss`)) {
        LivePbpPublicObject[["hd_miss"]] <-
          self$`hd_miss`
      }
      if (!is.null(self$`fenwick`)) {
        LivePbpPublicObject[["fenwick"]] <-
          self$`fenwick`
      }
      if (!is.null(self$`fenwick_adj`)) {
        LivePbpPublicObject[["fenwick_adj"]] <-
          self$`fenwick_adj`
      }
      if (!is.null(self$`hd_fenwick`)) {
        LivePbpPublicObject[["hd_fenwick"]] <-
          self$`hd_fenwick`
      }
      if (!is.null(self$`corsi`)) {
        LivePbpPublicObject[["corsi"]] <-
          self$`corsi`
      }
      if (!is.null(self$`corsi_adj`)) {
        LivePbpPublicObject[["corsi_adj"]] <-
          self$`corsi_adj`
      }
      if (!is.null(self$`block`)) {
        LivePbpPublicObject[["block"]] <-
          self$`block`
      }
      if (!is.null(self$`block_adj`)) {
        LivePbpPublicObject[["block_adj"]] <-
          self$`block_adj`
      }
      if (!is.null(self$`teammate_block`)) {
        LivePbpPublicObject[["teammate_block"]] <-
          self$`teammate_block`
      }
      if (!is.null(self$`teammate_block_adj`)) {
        LivePbpPublicObject[["teammate_block_adj"]] <-
          self$`teammate_block_adj`
      }
      if (!is.null(self$`hit`)) {
        LivePbpPublicObject[["hit"]] <-
          self$`hit`
      }
      if (!is.null(self$`give`)) {
        LivePbpPublicObject[["give"]] <-
          self$`give`
      }
      if (!is.null(self$`take`)) {
        LivePbpPublicObject[["take"]] <-
          self$`take`
      }
      if (!is.null(self$`fac`)) {
        LivePbpPublicObject[["fac"]] <-
          self$`fac`
      }
      if (!is.null(self$`penl`)) {
        LivePbpPublicObject[["penl"]] <-
          self$`penl`
      }
      if (!is.null(self$`change`)) {
        LivePbpPublicObject[["change"]] <-
          self$`change`
      }
      if (!is.null(self$`stop`)) {
        LivePbpPublicObject[["stop"]] <-
          self$`stop`
      }
      if (!is.null(self$`chl`)) {
        LivePbpPublicObject[["chl"]] <-
          self$`chl`
      }
      if (!is.null(self$`ozf`)) {
        LivePbpPublicObject[["ozf"]] <-
          self$`ozf`
      }
      if (!is.null(self$`nzf`)) {
        LivePbpPublicObject[["nzf"]] <-
          self$`nzf`
      }
      if (!is.null(self$`dzf`)) {
        LivePbpPublicObject[["dzf"]] <-
          self$`dzf`
      }
      if (!is.null(self$`ozc`)) {
        LivePbpPublicObject[["ozc"]] <-
          self$`ozc`
      }
      if (!is.null(self$`nzc`)) {
        LivePbpPublicObject[["nzc"]] <-
          self$`nzc`
      }
      if (!is.null(self$`dzc`)) {
        LivePbpPublicObject[["dzc"]] <-
          self$`dzc`
      }
      if (!is.null(self$`otf`)) {
        LivePbpPublicObject[["otf"]] <-
          self$`otf`
      }
      if (!is.null(self$`pen0`)) {
        LivePbpPublicObject[["pen0"]] <-
          self$`pen0`
      }
      if (!is.null(self$`pen2`)) {
        LivePbpPublicObject[["pen2"]] <-
          self$`pen2`
      }
      if (!is.null(self$`pen4`)) {
        LivePbpPublicObject[["pen4"]] <-
          self$`pen4`
      }
      if (!is.null(self$`pen5`)) {
        LivePbpPublicObject[["pen5"]] <-
          self$`pen5`
      }
      ...
      return(LivePbpPublicObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of LivePbpPublic
    #'
    #' @param input_json the JSON input
    #' @return the instance of LivePbpPublic
    ...
    #' @return LivePbpPublic in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to LivePbpPublic and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LivePbpPublic: the required field `id` is missing."))
      }
      ...
      if (!is.null(input_json$`season`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LivePbpPublic: the required field `season` is missing."))
      }
      ...
      if (!is.null(input_json$`session`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LivePbpPublic: the required field `session` is missing."))
      }
      ...
      if (!is.null(input_json$`event_idx`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LivePbpPublic: the required field `event_idx` is missing."))
      }
      ...
      if (!is.null(input_json$`period`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LivePbpPublic: the required field `period` is missing."))
      }
      ...
      if (!is.null(input_json$`period_seconds`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LivePbpPublic: the required field `period_seconds` is missing."))
      }
      ...
      if (!is.null(input_json$`game_seconds`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LivePbpPublic: the required field `game_seconds` is missing."))
      }
      ...
      if (!is.null(input_json$`event`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LivePbpPublic: the required field `event` is missing."))
      }
      ...
      if (!is.null(input_json$`score_diff`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LivePbpPublic: the required field `score_diff` is missing."))
      }
      # check the required field `forwards_percent`
      if (!is.null(input_json$`forwards_percent`)) {
      } else {
        stop(paste("The JSON input `", input, "` is invalid for LivePbpPublic: the required field `forwards_percent` is missing."))
      }
      # check the required field `opp_forwards_percent`
      if (!is.null(input_json$`opp_forwards_percent`)) {
      } else {
        stop(paste("The JSON input `", input, "` is invalid for LivePbpPublic: the required field `opp_forwards_percent` is missing."))
      }
      ...
      if (!is.null(input_json$`home_score`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LivePbpPublic: the required field `home_score` is missing."))
      }
      ...
      if (!is.null(input_json$`home_score_diff`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LivePbpPublic: the required field `home_score_diff` is missing."))
      }
      ...
      if (!is.null(input_json$`away_score`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LivePbpPublic: the required field `away_score` is missing."))
      }
      ...
      if (!is.null(input_json$`away_score_diff`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LivePbpPublic: the required field `away_score_diff` is missing."))
      }
      ...
      if (!is.null(input_json$`is_home`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LivePbpPublic: the required field `is_home` is missing."))
      }
      ...
      if (!is.null(input_json$`home_skaters`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LivePbpPublic: the required field `home_skaters` is missing."))
      }
      ...
      if (!is.null(input_json$`away_skaters`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LivePbpPublic: the required field `away_skaters` is missing."))
      }
      ...
      if (!is.null(input_json$`last_updated`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LivePbpPublic: the required field `last_updated` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of LivePbpPublic
    toString = function() {
      self$toJSONString()
    },
...
# LivePbpPublic$unlock()
#
## Below is an example to define the print function
# LivePbpPublic$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
