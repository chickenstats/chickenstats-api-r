#' Create a new TeamStatsCreate
#'
#' @description
#' TeamStatsCreate Class
#'
#' @docType class
#' @title TeamStatsCreate
#' @description TeamStatsCreate Class
...
TeamStatsCreate <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return TeamStatsCreate as a base R list.
    #' @examples
    #' # convert array of TeamStatsCreate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert TeamStatsCreate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      TeamStatsCreateObject <- list()
      if (!is.null(self$`toi`)) {
        TeamStatsCreateObject[["toi"]] <-
          self$`toi`
      }
      if (!is.null(self$`gf`)) {
        TeamStatsCreateObject[["gf"]] <-
          self$`gf`
      }
      if (!is.null(self$`ga`)) {
        TeamStatsCreateObject[["ga"]] <-
          self$`ga`
      }
      if (!is.null(self$`gf_adj`)) {
        TeamStatsCreateObject[["gf_adj"]] <-
          self$`gf_adj`
      }
      if (!is.null(self$`ga_adj`)) {
        TeamStatsCreateObject[["ga_adj"]] <-
          self$`ga_adj`
      }
      if (!is.null(self$`hdgf`)) {
        TeamStatsCreateObject[["hdgf"]] <-
          self$`hdgf`
      }
      if (!is.null(self$`hdga`)) {
        TeamStatsCreateObject[["hdga"]] <-
          self$`hdga`
      }
      if (!is.null(self$`base_xgf`)) {
        TeamStatsCreateObject[["base_xgf"]] <-
          self$`base_xgf`
      }
      if (!is.null(self$`base_xga`)) {
        TeamStatsCreateObject[["base_xga"]] <-
          self$`base_xga`
      }
      if (!is.null(self$`base_xgf_adj`)) {
        TeamStatsCreateObject[["base_xgf_adj"]] <-
          self$`base_xgf_adj`
      }
      if (!is.null(self$`base_xga_adj`)) {
        TeamStatsCreateObject[["base_xga_adj"]] <-
          self$`base_xga_adj`
      }
      if (!is.null(self$`context_xgf`)) {
        TeamStatsCreateObject[["context_xgf"]] <-
          self$`context_xgf`
      }
      if (!is.null(self$`context_xga`)) {
        TeamStatsCreateObject[["context_xga"]] <-
          self$`context_xga`
      }
      if (!is.null(self$`context_xgf_adj`)) {
        TeamStatsCreateObject[["context_xgf_adj"]] <-
          self$`context_xgf_adj`
      }
      if (!is.null(self$`context_xga_adj`)) {
        TeamStatsCreateObject[["context_xga_adj"]] <-
          self$`context_xga_adj`
      }
      if (!is.null(self$`xgf`)) {
        TeamStatsCreateObject[["xgf"]] <-
          self$`xgf`
      }
      if (!is.null(self$`xga`)) {
        TeamStatsCreateObject[["xga"]] <-
          self$`xga`
      }
      if (!is.null(self$`xgf_adj`)) {
        TeamStatsCreateObject[["xgf_adj"]] <-
          self$`xgf_adj`
      }
      if (!is.null(self$`xga_adj`)) {
        TeamStatsCreateObject[["xga_adj"]] <-
          self$`xga_adj`
      }
      if (!is.null(self$`sf`)) {
        TeamStatsCreateObject[["sf"]] <-
          self$`sf`
      }
      if (!is.null(self$`sa`)) {
        TeamStatsCreateObject[["sa"]] <-
          self$`sa`
      }
      if (!is.null(self$`sf_adj`)) {
        TeamStatsCreateObject[["sf_adj"]] <-
          self$`sf_adj`
      }
      if (!is.null(self$`sa_adj`)) {
        TeamStatsCreateObject[["sa_adj"]] <-
          self$`sa_adj`
      }
      if (!is.null(self$`hdsf`)) {
        TeamStatsCreateObject[["hdsf"]] <-
          self$`hdsf`
      }
      if (!is.null(self$`hdsa`)) {
        TeamStatsCreateObject[["hdsa"]] <-
          self$`hdsa`
      }
      if (!is.null(self$`ff`)) {
        TeamStatsCreateObject[["ff"]] <-
          self$`ff`
      }
      if (!is.null(self$`fa`)) {
        TeamStatsCreateObject[["fa"]] <-
          self$`fa`
      }
      if (!is.null(self$`ff_adj`)) {
        TeamStatsCreateObject[["ff_adj"]] <-
          self$`ff_adj`
      }
      if (!is.null(self$`fa_adj`)) {
        TeamStatsCreateObject[["fa_adj"]] <-
          self$`fa_adj`
      }
      if (!is.null(self$`hdff`)) {
        TeamStatsCreateObject[["hdff"]] <-
          self$`hdff`
      }
      if (!is.null(self$`hdfa`)) {
        TeamStatsCreateObject[["hdfa"]] <-
          self$`hdfa`
      }
      if (!is.null(self$`cf`)) {
        TeamStatsCreateObject[["cf"]] <-
          self$`cf`
      }
      if (!is.null(self$`ca`)) {
        TeamStatsCreateObject[["ca"]] <-
          self$`ca`
      }
      if (!is.null(self$`cf_adj`)) {
        TeamStatsCreateObject[["cf_adj"]] <-
          self$`cf_adj`
      }
      if (!is.null(self$`ca_adj`)) {
        TeamStatsCreateObject[["ca_adj"]] <-
          self$`ca_adj`
      }
      if (!is.null(self$`bsf`)) {
        TeamStatsCreateObject[["bsf"]] <-
          self$`bsf`
      }
      if (!is.null(self$`bsa`)) {
        TeamStatsCreateObject[["bsa"]] <-
          self$`bsa`
      }
      if (!is.null(self$`bsf_adj`)) {
        TeamStatsCreateObject[["bsf_adj"]] <-
          self$`bsf_adj`
      }
      if (!is.null(self$`bsa_adj`)) {
        TeamStatsCreateObject[["bsa_adj"]] <-
          self$`bsa_adj`
      }
      if (!is.null(self$`msf`)) {
        TeamStatsCreateObject[["msf"]] <-
          self$`msf`
      }
      if (!is.null(self$`msa`)) {
        TeamStatsCreateObject[["msa"]] <-
          self$`msa`
      }
      if (!is.null(self$`msf_adj`)) {
        TeamStatsCreateObject[["msf_adj"]] <-
          self$`msf_adj`
      }
      if (!is.null(self$`msa_adj`)) {
        TeamStatsCreateObject[["msa_adj"]] <-
          self$`msa_adj`
      }
      if (!is.null(self$`hdmsf`)) {
        TeamStatsCreateObject[["hdmsf"]] <-
          self$`hdmsf`
      }
      if (!is.null(self$`hdmsa`)) {
        TeamStatsCreateObject[["hdmsa"]] <-
          self$`hdmsa`
      }
      if (!is.null(self$`teammate_block`)) {
        TeamStatsCreateObject[["teammate_block"]] <-
          self$`teammate_block`
      }
      if (!is.null(self$`teammate_block_adj`)) {
        TeamStatsCreateObject[["teammate_block_adj"]] <-
          self$`teammate_block_adj`
      }
      if (!is.null(self$`hf`)) {
        TeamStatsCreateObject[["hf"]] <-
          self$`hf`
      }
      if (!is.null(self$`ht`)) {
        TeamStatsCreateObject[["ht"]] <-
          self$`ht`
      }
      if (!is.null(self$`ozf`)) {
        TeamStatsCreateObject[["ozf"]] <-
          self$`ozf`
      }
      if (!is.null(self$`nzf`)) {
        TeamStatsCreateObject[["nzf"]] <-
          self$`nzf`
      }
      if (!is.null(self$`dzf`)) {
        TeamStatsCreateObject[["dzf"]] <-
          self$`dzf`
      }
      if (!is.null(self$`fow`)) {
        TeamStatsCreateObject[["fow"]] <-
          self$`fow`
      }
      if (!is.null(self$`fol`)) {
        TeamStatsCreateObject[["fol"]] <-
          self$`fol`
      }
      if (!is.null(self$`ozfw`)) {
        TeamStatsCreateObject[["ozfw"]] <-
          self$`ozfw`
      }
      if (!is.null(self$`ozfl`)) {
        TeamStatsCreateObject[["ozfl"]] <-
          self$`ozfl`
      }
      if (!is.null(self$`nzfw`)) {
        TeamStatsCreateObject[["nzfw"]] <-
          self$`nzfw`
      }
      if (!is.null(self$`nzfl`)) {
        TeamStatsCreateObject[["nzfl"]] <-
          self$`nzfl`
      }
      if (!is.null(self$`dzfw`)) {
        TeamStatsCreateObject[["dzfw"]] <-
          self$`dzfw`
      }
      if (!is.null(self$`dzfl`)) {
        TeamStatsCreateObject[["dzfl"]] <-
          self$`dzfl`
      }
      if (!is.null(self$`pent0`)) {
        TeamStatsCreateObject[["pent0"]] <-
          self$`pent0`
      }
      if (!is.null(self$`pent2`)) {
        TeamStatsCreateObject[["pent2"]] <-
          self$`pent2`
      }
      if (!is.null(self$`pent4`)) {
        TeamStatsCreateObject[["pent4"]] <-
          self$`pent4`
      }
      if (!is.null(self$`pent5`)) {
        TeamStatsCreateObject[["pent5"]] <-
          self$`pent5`
      }
      if (!is.null(self$`pent10`)) {
        TeamStatsCreateObject[["pent10"]] <-
          self$`pent10`
      }
      if (!is.null(self$`pend0`)) {
        TeamStatsCreateObject[["pend0"]] <-
          self$`pend0`
      }
      if (!is.null(self$`pend2`)) {
        TeamStatsCreateObject[["pend2"]] <-
          self$`pend2`
      }
      if (!is.null(self$`pend4`)) {
        TeamStatsCreateObject[["pend4"]] <-
          self$`pend4`
      }
      if (!is.null(self$`pend5`)) {
        TeamStatsCreateObject[["pend5"]] <-
          self$`pend5`
      }
      if (!is.null(self$`pend10`)) {
        TeamStatsCreateObject[["pend10"]] <-
          self$`pend10`
      }
      if (!is.null(self$`season`)) {
        TeamStatsCreateObject[["season"]] <-
          self$`season`
      }
      if (!is.null(self$`session`)) {
        TeamStatsCreateObject[["session"]] <-
          self$`session`
      }
      ...
      if (!is.null(self$`opp_team`)) {
        TeamStatsCreateObject[["opp_team"]] <-
          self$`opp_team`
      }
      if (!is.null(self$`strength_state`)) {
        TeamStatsCreateObject[["strength_state"]] <-
          self$`strength_state`
      }
      if (!is.null(self$`period`)) {
        TeamStatsCreateObject[["period"]] <-
          self$`period`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of TeamStatsCreate
    #'
    #' @param input_json the JSON input
    #' @return the instance of TeamStatsCreate
    ...
    #' @return TeamStatsCreate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to TeamStatsCreate and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`toi`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TeamStatsCreate: the required field `toi` is missing."))
      }
      ...
      if (!is.null(input_json$`season`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TeamStatsCreate: the required field `season` is missing."))
      }
      ...
      if (!is.null(input_json$`session`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TeamStatsCreate: the required field `session` is missing."))
      }
    ...
    #'
    #' @return String representation of TeamStatsCreate
    toString = function() {
      self$toJSONString()
    },
...
# TeamStatsCreate$unlock()
#
## Below is an example to define the print function
# TeamStatsCreate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# TeamStatsCreate$lock()
