...
LinesSeason <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new LinesSeason class.
    #'
    #' @param toi toi
    #' @param season season
    ...
    #'
    #' @return LinesSeason as a base R list.
    #' @examples
    #' # convert array of LinesSeason (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert LinesSeason to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      LinesSeasonObject <- list()
      if (!is.null(self$`toi`)) {
        LinesSeasonObject[["toi"]] <-
          self$`toi`
      }
      if (!is.null(self$`gf`)) {
        LinesSeasonObject[["gf"]] <-
          self$`gf`
      }
      if (!is.null(self$`ga`)) {
        LinesSeasonObject[["ga"]] <-
          self$`ga`
      }
      if (!is.null(self$`gf_adj`)) {
        LinesSeasonObject[["gf_adj"]] <-
          self$`gf_adj`
      }
      if (!is.null(self$`ga_adj`)) {
        LinesSeasonObject[["ga_adj"]] <-
          self$`ga_adj`
      }
      if (!is.null(self$`hdgf`)) {
        LinesSeasonObject[["hdgf"]] <-
          self$`hdgf`
      }
      if (!is.null(self$`hdga`)) {
        LinesSeasonObject[["hdga"]] <-
          self$`hdga`
      }
      if (!is.null(self$`base_xgf`)) {
        LinesSeasonObject[["base_xgf"]] <-
          self$`base_xgf`
      }
      if (!is.null(self$`base_xga`)) {
        LinesSeasonObject[["base_xga"]] <-
          self$`base_xga`
      }
      if (!is.null(self$`base_xgf_adj`)) {
        LinesSeasonObject[["base_xgf_adj"]] <-
          self$`base_xgf_adj`
      }
      if (!is.null(self$`base_xga_adj`)) {
        LinesSeasonObject[["base_xga_adj"]] <-
          self$`base_xga_adj`
      }
      if (!is.null(self$`context_xgf`)) {
        LinesSeasonObject[["context_xgf"]] <-
          self$`context_xgf`
      }
      if (!is.null(self$`context_xga`)) {
        LinesSeasonObject[["context_xga"]] <-
          self$`context_xga`
      }
      if (!is.null(self$`context_xgf_adj`)) {
        LinesSeasonObject[["context_xgf_adj"]] <-
          self$`context_xgf_adj`
      }
      if (!is.null(self$`context_xga_adj`)) {
        LinesSeasonObject[["context_xga_adj"]] <-
          self$`context_xga_adj`
      }
      if (!is.null(self$`xgf`)) {
        LinesSeasonObject[["xgf"]] <-
          self$`xgf`
      }
      if (!is.null(self$`xga`)) {
        LinesSeasonObject[["xga"]] <-
          self$`xga`
      }
      if (!is.null(self$`xgf_adj`)) {
        LinesSeasonObject[["xgf_adj"]] <-
          self$`xgf_adj`
      }
      if (!is.null(self$`xga_adj`)) {
        LinesSeasonObject[["xga_adj"]] <-
          self$`xga_adj`
      }
      if (!is.null(self$`sf`)) {
        LinesSeasonObject[["sf"]] <-
          self$`sf`
      }
      if (!is.null(self$`sa`)) {
        LinesSeasonObject[["sa"]] <-
          self$`sa`
      }
      if (!is.null(self$`sf_adj`)) {
        LinesSeasonObject[["sf_adj"]] <-
          self$`sf_adj`
      }
      if (!is.null(self$`sa_adj`)) {
        LinesSeasonObject[["sa_adj"]] <-
          self$`sa_adj`
      }
      if (!is.null(self$`hdsf`)) {
        LinesSeasonObject[["hdsf"]] <-
          self$`hdsf`
      }
      if (!is.null(self$`hdsa`)) {
        LinesSeasonObject[["hdsa"]] <-
          self$`hdsa`
      }
      if (!is.null(self$`ff`)) {
        LinesSeasonObject[["ff"]] <-
          self$`ff`
      }
      if (!is.null(self$`fa`)) {
        LinesSeasonObject[["fa"]] <-
          self$`fa`
      }
      if (!is.null(self$`ff_adj`)) {
        LinesSeasonObject[["ff_adj"]] <-
          self$`ff_adj`
      }
      if (!is.null(self$`fa_adj`)) {
        LinesSeasonObject[["fa_adj"]] <-
          self$`fa_adj`
      }
      if (!is.null(self$`hdff`)) {
        LinesSeasonObject[["hdff"]] <-
          self$`hdff`
      }
      if (!is.null(self$`hdfa`)) {
        LinesSeasonObject[["hdfa"]] <-
          self$`hdfa`
      }
      if (!is.null(self$`cf`)) {
        LinesSeasonObject[["cf"]] <-
          self$`cf`
      }
      if (!is.null(self$`ca`)) {
        LinesSeasonObject[["ca"]] <-
          self$`ca`
      }
      if (!is.null(self$`cf_adj`)) {
        LinesSeasonObject[["cf_adj"]] <-
          self$`cf_adj`
      }
      if (!is.null(self$`ca_adj`)) {
        LinesSeasonObject[["ca_adj"]] <-
          self$`ca_adj`
      }
      if (!is.null(self$`bsf`)) {
        LinesSeasonObject[["bsf"]] <-
          self$`bsf`
      }
      if (!is.null(self$`bsa`)) {
        LinesSeasonObject[["bsa"]] <-
          self$`bsa`
      }
      if (!is.null(self$`bsf_adj`)) {
        LinesSeasonObject[["bsf_adj"]] <-
          self$`bsf_adj`
      }
      if (!is.null(self$`bsa_adj`)) {
        LinesSeasonObject[["bsa_adj"]] <-
          self$`bsa_adj`
      }
      if (!is.null(self$`msf`)) {
        LinesSeasonObject[["msf"]] <-
          self$`msf`
      }
      if (!is.null(self$`msa`)) {
        LinesSeasonObject[["msa"]] <-
          self$`msa`
      }
      if (!is.null(self$`msf_adj`)) {
        LinesSeasonObject[["msf_adj"]] <-
          self$`msf_adj`
      }
      if (!is.null(self$`msa_adj`)) {
        LinesSeasonObject[["msa_adj"]] <-
          self$`msa_adj`
      }
      if (!is.null(self$`hdmsf`)) {
        LinesSeasonObject[["hdmsf"]] <-
          self$`hdmsf`
      }
      if (!is.null(self$`hdmsa`)) {
        LinesSeasonObject[["hdmsa"]] <-
          self$`hdmsa`
      }
      if (!is.null(self$`teammate_block`)) {
        LinesSeasonObject[["teammate_block"]] <-
          self$`teammate_block`
      }
      if (!is.null(self$`teammate_block_adj`)) {
        LinesSeasonObject[["teammate_block_adj"]] <-
          self$`teammate_block_adj`
      }
      if (!is.null(self$`hf`)) {
        LinesSeasonObject[["hf"]] <-
          self$`hf`
      }
      if (!is.null(self$`ht`)) {
        LinesSeasonObject[["ht"]] <-
          self$`ht`
      }
      if (!is.null(self$`ozf`)) {
        LinesSeasonObject[["ozf"]] <-
          self$`ozf`
      }
      if (!is.null(self$`nzf`)) {
        LinesSeasonObject[["nzf"]] <-
          self$`nzf`
      }
      if (!is.null(self$`dzf`)) {
        LinesSeasonObject[["dzf"]] <-
          self$`dzf`
      }
      if (!is.null(self$`fow`)) {
        LinesSeasonObject[["fow"]] <-
          self$`fow`
      }
      if (!is.null(self$`fol`)) {
        LinesSeasonObject[["fol"]] <-
          self$`fol`
      }
      if (!is.null(self$`ozfw`)) {
        LinesSeasonObject[["ozfw"]] <-
          self$`ozfw`
      }
      if (!is.null(self$`ozfl`)) {
        LinesSeasonObject[["ozfl"]] <-
          self$`ozfl`
      }
      if (!is.null(self$`nzfw`)) {
        LinesSeasonObject[["nzfw"]] <-
          self$`nzfw`
      }
      if (!is.null(self$`nzfl`)) {
        LinesSeasonObject[["nzfl"]] <-
          self$`nzfl`
      }
      if (!is.null(self$`dzfw`)) {
        LinesSeasonObject[["dzfw"]] <-
          self$`dzfw`
      }
      if (!is.null(self$`dzfl`)) {
        LinesSeasonObject[["dzfl"]] <-
          self$`dzfl`
      }
      if (!is.null(self$`pent0`)) {
        LinesSeasonObject[["pent0"]] <-
          self$`pent0`
      }
      if (!is.null(self$`pent2`)) {
        LinesSeasonObject[["pent2"]] <-
          self$`pent2`
      }
      if (!is.null(self$`pent4`)) {
        LinesSeasonObject[["pent4"]] <-
          self$`pent4`
      }
      if (!is.null(self$`pent5`)) {
        LinesSeasonObject[["pent5"]] <-
          self$`pent5`
      }
      if (!is.null(self$`pent10`)) {
        LinesSeasonObject[["pent10"]] <-
          self$`pent10`
      }
      if (!is.null(self$`pend0`)) {
        LinesSeasonObject[["pend0"]] <-
          self$`pend0`
      }
      if (!is.null(self$`pend2`)) {
        LinesSeasonObject[["pend2"]] <-
          self$`pend2`
      }
      if (!is.null(self$`pend4`)) {
        LinesSeasonObject[["pend4"]] <-
          self$`pend4`
      }
      if (!is.null(self$`pend5`)) {
        LinesSeasonObject[["pend5"]] <-
          self$`pend5`
      }
      if (!is.null(self$`pend10`)) {
        LinesSeasonObject[["pend10"]] <-
          self$`pend10`
      }
      if (!is.null(self$`season`)) {
        LinesSeasonObject[["season"]] <-
          self$`season`
      }
      if (!is.null(self$`session`)) {
        LinesSeasonObject[["session"]] <-
          self$`session`
      }
      if (!is.null(self$`game_id`)) {
        LinesSeasonObject[["game_id"]] <-
          self$`game_id`
      }
      if (!is.null(self$`game_date`)) {
        LinesSeasonObject[["game_date"]] <-
          self$`game_date`
      }
      if (!is.null(self$`team`)) {
        LinesSeasonObject[["team"]] <-
          self$`team`
      }
      if (!is.null(self$`opp_team`)) {
        LinesSeasonObject[["opp_team"]] <-
          self$`opp_team`
      }
      if (!is.null(self$`strength_state`)) {
        LinesSeasonObject[["strength_state"]] <-
          self$`strength_state`
      }
      if (!is.null(self$`period`)) {
        LinesSeasonObject[["period"]] <-
          self$`period`
      }
      if (!is.null(self$`score_state`)) {
        LinesSeasonObject[["score_state"]] <-
          self$`score_state`
      }
      if (!is.null(self$`forwards`)) {
        LinesSeasonObject[["forwards"]] <-
          self$`forwards`
      }
      if (!is.null(self$`forwards_eh_id`)) {
        LinesSeasonObject[["forwards_eh_id"]] <-
          self$`forwards_eh_id`
      }
      if (!is.null(self$`forwards_api_id`)) {
        LinesSeasonObject[["forwards_api_id"]] <-
          self$`forwards_api_id`
      }
      if (!is.null(self$`defense`)) {
        LinesSeasonObject[["defense"]] <-
          self$`defense`
      }
      if (!is.null(self$`defense_eh_id`)) {
        LinesSeasonObject[["defense_eh_id"]] <-
          self$`defense_eh_id`
      }
      if (!is.null(self$`defense_api_id`)) {
        LinesSeasonObject[["defense_api_id"]] <-
          self$`defense_api_id`
      }
      if (!is.null(self$`own_goalie`)) {
        LinesSeasonObject[["own_goalie"]] <-
          self$`own_goalie`
      }
      if (!is.null(self$`own_goalie_eh_id`)) {
        LinesSeasonObject[["own_goalie_eh_id"]] <-
          self$`own_goalie_eh_id`
      }
      if (!is.null(self$`own_goalie_api_id`)) {
        LinesSeasonObject[["own_goalie_api_id"]] <-
          self$`own_goalie_api_id`
      }
      if (!is.null(self$`opp_forwards`)) {
        LinesSeasonObject[["opp_forwards"]] <-
          self$`opp_forwards`
      }
      if (!is.null(self$`opp_forwards_eh_id`)) {
        LinesSeasonObject[["opp_forwards_eh_id"]] <-
          self$`opp_forwards_eh_id`
      }
      if (!is.null(self$`opp_forwards_api_id`)) {
        LinesSeasonObject[["opp_forwards_api_id"]] <-
          self$`opp_forwards_api_id`
      }
      if (!is.null(self$`opp_defense`)) {
        LinesSeasonObject[["opp_defense"]] <-
          self$`opp_defense`
      }
      if (!is.null(self$`opp_defense_eh_id`)) {
        LinesSeasonObject[["opp_defense_eh_id"]] <-
          self$`opp_defense_eh_id`
      }
      if (!is.null(self$`opp_defense_api_id`)) {
        LinesSeasonObject[["opp_defense_api_id"]] <-
          self$`opp_defense_api_id`
      }
      if (!is.null(self$`opp_goalie`)) {
        LinesSeasonObject[["opp_goalie"]] <-
          self$`opp_goalie`
      }
      if (!is.null(self$`opp_goalie_eh_id`)) {
        LinesSeasonObject[["opp_goalie_eh_id"]] <-
          self$`opp_goalie_eh_id`
      }
      if (!is.null(self$`opp_goalie_api_id`)) {
        LinesSeasonObject[["opp_goalie_api_id"]] <-
          self$`opp_goalie_api_id`
      }
      return(LinesSeasonObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of LinesSeason
    #'
    #' @param input_json the JSON input
    #' @return the instance of LinesSeason
    ...
    #' @return LinesSeason in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to LinesSeason and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`toi`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LinesSeason: the required field `toi` is missing."))
      }
      ...
      if (!is.null(input_json$`season`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LinesSeason: the required field `season` is missing."))
      }
      ...
      if (!is.null(input_json$`session`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LinesSeason: the required field `session` is missing."))
      }
      ...
      if (!is.null(input_json$`team`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LinesSeason: the required field `team` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of LinesSeason
    toString = function() {
      self$toJSONString()
    },
...
# LinesSeason$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
