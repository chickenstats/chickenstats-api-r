...
#' @description PlayerResponse Class
...
#' @field data  list(\link{PlayerPublic})
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PlayerResponse <- R6::R6Class(
  "PlayerResponse",
  public = list(
    `count` = NULL,
    `total` = NULL,
    ...
    #' @description
    #' Initialize a new PlayerResponse class.
    #'
    #' @param count count
    #' @param total total
    #' @param limit limit
    ...
    #'
    #' @return PlayerResponse as a base R list.
    #' @examples
    #' # convert array of PlayerResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PlayerResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PlayerResponseObject <- list()
      if (!is.null(self$`count`)) {
        PlayerResponseObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`total`)) {
        PlayerResponseObject[["total"]] <-
          self$`total`
      }
      if (!is.null(self$`limit`)) {
        PlayerResponseObject[["limit"]] <-
          self$`limit`
      }
      if (!is.null(self$`offset`)) {
        PlayerResponseObject[["offset"]] <-
          self$`offset`
      }
      if (!is.null(self$`has_next`)) {
        PlayerResponseObject[["has_next"]] <-
          self$`has_next`
      }
      if (!is.null(self$`data`)) {
        PlayerResponseObject[["data"]] <-
    ...
    #' @description
    #' Deserialize JSON string into an instance of PlayerResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of PlayerResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[PlayerPublic]", loadNamespace("chickenstats.api"))
      }
      self
    },
    ...
    #' @return PlayerResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PlayerResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`count`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PlayerResponse: the required field `count` is missing."))
      }
      ...
      if (!is.null(input_json$`total`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PlayerResponse: the required field `total` is missing."))
      }
      ...
      if (!is.null(input_json$`limit`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PlayerResponse: the required field `limit` is missing."))
      }
      ...
      if (!is.null(input_json$`offset`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PlayerResponse: the required field `offset` is missing."))
      }
      ...
      if (!is.null(input_json$`has_next`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PlayerResponse: the required field `has_next` is missing."))
      }
      ...
      if (!is.null(input_json$`data`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PlayerResponse: the required field `data` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of PlayerResponse
    toString = function() {
      self$toJSONString()
    },
...
# PlayerResponse$unlock()
#
## Below is an example to define the print function
# PlayerResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
