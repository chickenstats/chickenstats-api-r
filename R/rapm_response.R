...
#' @docType class
#' @title RapmResponse
#' @description RapmResponse Class
...
#' @field data  list(\link{RapmScores})
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
RapmResponse <- R6::R6Class(
  "RapmResponse",
  public = list(
    `count` = NULL,
    `total` = NULL,
    ...
    #' @description
    #' Initialize a new RapmResponse class.
    #'
    #' @param count count
    #' @param total total
    #' @param limit limit
    ...
    #'
    #' @return RapmResponse as a base R list.
    #' @examples
    #' # convert array of RapmResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert RapmResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      RapmResponseObject <- list()
      if (!is.null(self$`count`)) {
        RapmResponseObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`total`)) {
        RapmResponseObject[["total"]] <-
          self$`total`
      }
      if (!is.null(self$`limit`)) {
        RapmResponseObject[["limit"]] <-
          self$`limit`
      }
      if (!is.null(self$`offset`)) {
        RapmResponseObject[["offset"]] <-
          self$`offset`
      }
      if (!is.null(self$`has_next`)) {
        RapmResponseObject[["has_next"]] <-
          self$`has_next`
      }
      if (!is.null(self$`data`)) {
        RapmResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      return(RapmResponseObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of RapmResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of RapmResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[RapmScores]", loadNamespace("chickenstats.api"))
      }
      self
    },
    ...
    #' @return RapmResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to RapmResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`count`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RapmResponse: the required field `count` is missing."))
      }
      ...
      if (!is.null(input_json$`total`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RapmResponse: the required field `total` is missing."))
      }
      ...
      if (!is.null(input_json$`limit`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RapmResponse: the required field `limit` is missing."))
      }
      ...
      if (!is.null(input_json$`offset`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RapmResponse: the required field `offset` is missing."))
      }
      ...
      if (!is.null(input_json$`has_next`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RapmResponse: the required field `has_next` is missing."))
      }
      ...
      if (!is.null(input_json$`data`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RapmResponse: the required field `data` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of RapmResponse
    toString = function() {
      self$toJSONString()
    },
...
# RapmResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
