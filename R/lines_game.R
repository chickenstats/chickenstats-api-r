...
LinesGame <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new LinesGame class.
    #'
    #' @param toi toi
    #' @param season season
    ...
    #'
    #' @return LinesGame as a base R list.
    #' @examples
    #' # convert array of LinesGame (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert LinesGame to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      LinesGameObject <- list()
      if (!is.null(self$`toi`)) {
        LinesGameObject[["toi"]] <-
          self$`toi`
      }
      ...
      if (!is.null(self$`gf_adj`)) {
        LinesGameObject[["gf_adj"]] <-
          self$`gf_adj`
      }
      if (!is.null(self$`ga_adj`)) {
        LinesGameObject[["ga_adj"]] <-
          self$`ga_adj`
      }
      if (!is.null(self$`hdgf`)) {
        LinesGameObject[["hdgf"]] <-
          self$`hdgf`
      }
      ...
      if (!is.null(self$`xgf_adj`)) {
        LinesGameObject[["xgf_adj"]] <-
          self$`xgf_adj`
      }
      if (!is.null(self$`xga_adj`)) {
        LinesGameObject[["xga_adj"]] <-
          self$`xga_adj`
      }
      if (!is.null(self$`sf`)) {
        LinesGameObject[["sf"]] <-
      ...
      if (!is.null(self$`sf_adj`)) {
        LinesGameObject[["sf_adj"]] <-
          self$`sf_adj`
      }
      if (!is.null(self$`sa_adj`)) {
        LinesGameObject[["sa_adj"]] <-
          self$`sa_adj`
      }
      if (!is.null(self$`hdsf`)) {
        LinesGameObject[["hdsf"]] <-
          self$`hdsf`
      }
      if (!is.null(self$`hdsa`)) {
        LinesGameObject[["hdsa"]] <-
          self$`hdsa`
      }
      if (!is.null(self$`ff`)) {
        LinesGameObject[["ff"]] <-
      ...
      if (!is.null(self$`ff_adj`)) {
        LinesGameObject[["ff_adj"]] <-
          self$`ff_adj`
      }
      if (!is.null(self$`fa_adj`)) {
        LinesGameObject[["fa_adj"]] <-
          self$`fa_adj`
      }
      if (!is.null(self$`hdff`)) {
        LinesGameObject[["hdff"]] <-
          self$`hdff`
      }
      if (!is.null(self$`hdfa`)) {
        LinesGameObject[["hdfa"]] <-
          self$`hdfa`
      }
      if (!is.null(self$`cf`)) {
        LinesGameObject[["cf"]] <-
      ...
      if (!is.null(self$`cf_adj`)) {
        LinesGameObject[["cf_adj"]] <-
          self$`cf_adj`
      }
      if (!is.null(self$`ca_adj`)) {
        LinesGameObject[["ca_adj"]] <-
          self$`ca_adj`
      }
      if (!is.null(self$`bsf`)) {
        LinesGameObject[["bsf"]] <-
      ...
      if (!is.null(self$`bsf_adj`)) {
        LinesGameObject[["bsf_adj"]] <-
          self$`bsf_adj`
      }
      if (!is.null(self$`bsa_adj`)) {
        LinesGameObject[["bsa_adj"]] <-
          self$`bsa_adj`
      }
      if (!is.null(self$`msf`)) {
        LinesGameObject[["msf"]] <-
      ...
      if (!is.null(self$`msf_adj`)) {
        LinesGameObject[["msf_adj"]] <-
          self$`msf_adj`
      }
      if (!is.null(self$`msa_adj`)) {
        LinesGameObject[["msa_adj"]] <-
          self$`msa_adj`
      }
      if (!is.null(self$`hdmsf`)) {
        LinesGameObject[["hdmsf"]] <-
          self$`hdmsf`
      }
      if (!is.null(self$`hdmsa`)) {
        LinesGameObject[["hdmsa"]] <-
          self$`hdmsa`
      }
      if (!is.null(self$`teammate_block`)) {
        LinesGameObject[["teammate_block"]] <-
          self$`teammate_block`
      }
      if (!is.null(self$`teammate_block_adj`)) {
        LinesGameObject[["teammate_block_adj"]] <-
    ...
    #' @return LinesGame in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to LinesGame and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`toi`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LinesGame: the required field `toi` is missing."))
      }
      ...
      if (!is.null(input_json$`season`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LinesGame: the required field `season` is missing."))
      }
      ...
      if (!is.null(input_json$`session`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LinesGame: the required field `session` is missing."))
      }
      ...
      if (!is.null(input_json$`game_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LinesGame: the required field `game_id` is missing."))
      }
      ...
      if (!is.null(input_json$`game_date`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LinesGame: the required field `game_date` is missing."))
      }
      ...
      if (!is.null(input_json$`team`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LinesGame: the required field `team` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of LinesGame
    toString = function() {
      self$toJSONString()
    },
...
# LinesGame$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
