#' Create a new LivePbpResponse
#'
#' @description
#' LivePbpResponse Class
#'
#' @docType class
#' @title LivePbpResponse
#' @description LivePbpResponse Class
...
#' @field data  list(\link{LivePbpPublic})
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
LivePbpResponse <- R6::R6Class(
  "LivePbpResponse",
  public = list(
    `count` = NULL,
    `total` = NULL,
    ...
    #' @description
    #' Initialize a new LivePbpResponse class.
    #'
    #' @param count count
    #' @param total total
    #' @param limit limit
    ...
    #'
    #' @return LivePbpResponse as a base R list.
    #' @examples
    #' # convert array of LivePbpResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert LivePbpResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      LivePbpResponseObject <- list()
      if (!is.null(self$`count`)) {
        LivePbpResponseObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`total`)) {
        LivePbpResponseObject[["total"]] <-
          self$`total`
      }
      if (!is.null(self$`limit`)) {
        LivePbpResponseObject[["limit"]] <-
          self$`limit`
      }
      if (!is.null(self$`offset`)) {
        LivePbpResponseObject[["offset"]] <-
          self$`offset`
      }
      if (!is.null(self$`has_next`)) {
        LivePbpResponseObject[["has_next"]] <-
          self$`has_next`
      }
      if (!is.null(self$`data`)) {
        LivePbpResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      return(LivePbpResponseObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of LivePbpResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of LivePbpResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[LivePbpPublic]", loadNamespace("chickenstats.api"))
      }
      self
    },
    ...
    #' @return LivePbpResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to LivePbpResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`count`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LivePbpResponse: the required field `count` is missing."))
      }
      ...
      if (!is.null(input_json$`total`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LivePbpResponse: the required field `total` is missing."))
      }
      ...
      if (!is.null(input_json$`limit`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LivePbpResponse: the required field `limit` is missing."))
      }
      ...
      if (!is.null(input_json$`offset`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LivePbpResponse: the required field `offset` is missing."))
      }
      ...
      if (!is.null(input_json$`has_next`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LivePbpResponse: the required field `has_next` is missing."))
      }
      ...
      if (!is.null(input_json$`data`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LivePbpResponse: the required field `data` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of LivePbpResponse
    toString = function() {
      self$toJSONString()
    },
...
# LivePbpResponse$unlock()
#
## Below is an example to define the print function
# LivePbpResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# LivePbpResponse$lock()
