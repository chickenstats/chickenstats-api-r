  ...
  public = list(
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`base_xgf`)) {
        LinesPublicObject[["base_xgf"]] <-
          self$`base_xgf`
      }
      if (!is.null(self$`base_xga`)) {
        LinesPublicObject[["base_xga"]] <-
          self$`base_xga`
      }
      if (!is.null(self$`base_xgf_adj`)) {
        LinesPublicObject[["base_xgf_adj"]] <-
          self$`base_xgf_adj`
      }
      if (!is.null(self$`base_xga_adj`)) {
        LinesPublicObject[["base_xga_adj"]] <-
          self$`base_xga_adj`
      }
      if (!is.null(self$`context_xgf`)) {
        LinesPublicObject[["context_xgf"]] <-
          self$`context_xgf`
      }
      if (!is.null(self$`context_xga`)) {
        LinesPublicObject[["context_xga"]] <-
          self$`context_xga`
      }
      if (!is.null(self$`context_xgf_adj`)) {
        LinesPublicObject[["context_xgf_adj"]] <-
          self$`context_xgf_adj`
      }
      if (!is.null(self$`context_xga_adj`)) {
        LinesPublicObject[["context_xga_adj"]] <-
