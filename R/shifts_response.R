#' Create a new ShiftsResponse
#'
#' @description
#' ShiftsResponse Class
#'
#' @docType class
#' @title ShiftsResponse
#' @description ShiftsResponse Class
...
#' @field data  list(\link{ShiftsPublic})
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ShiftsResponse <- R6::R6Class(
  "ShiftsResponse",
  public = list(
    `count` = NULL,
    `total` = NULL,
    ...
    #' @description
    #' Initialize a new ShiftsResponse class.
    #'
    #' @param count count
    #' @param total total
    #' @param limit limit
    ...
    #'
    #' @return ShiftsResponse as a base R list.
    #' @examples
    #' # convert array of ShiftsResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ShiftsResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ShiftsResponseObject <- list()
      if (!is.null(self$`count`)) {
        ShiftsResponseObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`total`)) {
        ShiftsResponseObject[["total"]] <-
          self$`total`
      }
      if (!is.null(self$`limit`)) {
        ShiftsResponseObject[["limit"]] <-
          self$`limit`
      }
      if (!is.null(self$`offset`)) {
        ShiftsResponseObject[["offset"]] <-
          self$`offset`
      }
      if (!is.null(self$`has_next`)) {
        ShiftsResponseObject[["has_next"]] <-
          self$`has_next`
      }
      if (!is.null(self$`data`)) {
        ShiftsResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      return(ShiftsResponseObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ShiftsResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of ShiftsResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[ShiftsPublic]", loadNamespace("chickenstats.api"))
      }
      self
    },
    ...
    #' @return ShiftsResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ShiftsResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`count`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ShiftsResponse: the required field `count` is missing."))
      }
      ...
      if (!is.null(input_json$`total`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ShiftsResponse: the required field `total` is missing."))
      }
      ...
      if (!is.null(input_json$`limit`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ShiftsResponse: the required field `limit` is missing."))
      }
      ...
      if (!is.null(input_json$`offset`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ShiftsResponse: the required field `offset` is missing."))
      }
      ...
      if (!is.null(input_json$`has_next`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ShiftsResponse: the required field `has_next` is missing."))
      }
      ...
      if (!is.null(input_json$`data`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ShiftsResponse: the required field `data` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ShiftsResponse
    toString = function() {
      self$toJSONString()
    },
...
# ShiftsResponse$unlock()
#
## Below is an example to define the print function
# ShiftsResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
