#' Create a new TeamStatsSeason
#'
#' @description
#' TeamStatsSeason Class
#'
#' @docType class
#' @title TeamStatsSeason
#' @description TeamStatsSeason Class
...
TeamStatsSeason <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new TeamStatsSeason class.
    #'
    #' @param toi toi
    #' @param season season
    ...
    #'
    #' @return TeamStatsSeason as a base R list.
    #' @examples
    #' # convert array of TeamStatsSeason (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert TeamStatsSeason to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      TeamStatsSeasonObject <- list()
      if (!is.null(self$`toi`)) {
        TeamStatsSeasonObject[["toi"]] <-
          self$`toi`
      }
      if (!is.null(self$`gf`)) {
        TeamStatsSeasonObject[["gf"]] <-
          self$`gf`
      }
      if (!is.null(self$`ga`)) {
        TeamStatsSeasonObject[["ga"]] <-
          self$`ga`
      }
      if (!is.null(self$`gf_adj`)) {
        TeamStatsSeasonObject[["gf_adj"]] <-
          self$`gf_adj`
      }
      if (!is.null(self$`ga_adj`)) {
        TeamStatsSeasonObject[["ga_adj"]] <-
          self$`ga_adj`
      }
      if (!is.null(self$`hdgf`)) {
        TeamStatsSeasonObject[["hdgf"]] <-
          self$`hdgf`
      }
      if (!is.null(self$`hdga`)) {
        TeamStatsSeasonObject[["hdga"]] <-
          self$`hdga`
      }
      if (!is.null(self$`base_xgf`)) {
        TeamStatsSeasonObject[["base_xgf"]] <-
          self$`base_xgf`
      }
      if (!is.null(self$`base_xga`)) {
        TeamStatsSeasonObject[["base_xga"]] <-
          self$`base_xga`
      }
      if (!is.null(self$`base_xgf_adj`)) {
        TeamStatsSeasonObject[["base_xgf_adj"]] <-
          self$`base_xgf_adj`
      }
      if (!is.null(self$`base_xga_adj`)) {
        TeamStatsSeasonObject[["base_xga_adj"]] <-
          self$`base_xga_adj`
      }
      if (!is.null(self$`context_xgf`)) {
        TeamStatsSeasonObject[["context_xgf"]] <-
          self$`context_xgf`
      }
      if (!is.null(self$`context_xga`)) {
        TeamStatsSeasonObject[["context_xga"]] <-
          self$`context_xga`
      }
      if (!is.null(self$`context_xgf_adj`)) {
        TeamStatsSeasonObject[["context_xgf_adj"]] <-
          self$`context_xgf_adj`
      }
      if (!is.null(self$`context_xga_adj`)) {
        TeamStatsSeasonObject[["context_xga_adj"]] <-
          self$`context_xga_adj`
      }
      if (!is.null(self$`xgf`)) {
        TeamStatsSeasonObject[["xgf"]] <-
          self$`xgf`
      }
      if (!is.null(self$`xga`)) {
        TeamStatsSeasonObject[["xga"]] <-
          self$`xga`
      }
      if (!is.null(self$`xgf_adj`)) {
        TeamStatsSeasonObject[["xgf_adj"]] <-
          self$`xgf_adj`
      }
      if (!is.null(self$`xga_adj`)) {
        TeamStatsSeasonObject[["xga_adj"]] <-
          self$`xga_adj`
      }
      if (!is.null(self$`sf`)) {
        TeamStatsSeasonObject[["sf"]] <-
          self$`sf`
      }
      if (!is.null(self$`sa`)) {
        TeamStatsSeasonObject[["sa"]] <-
          self$`sa`
      }
      if (!is.null(self$`sf_adj`)) {
        TeamStatsSeasonObject[["sf_adj"]] <-
          self$`sf_adj`
      }
      if (!is.null(self$`sa_adj`)) {
        TeamStatsSeasonObject[["sa_adj"]] <-
          self$`sa_adj`
      }
      if (!is.null(self$`hdsf`)) {
        TeamStatsSeasonObject[["hdsf"]] <-
          self$`hdsf`
      }
      if (!is.null(self$`hdsa`)) {
        TeamStatsSeasonObject[["hdsa"]] <-
          self$`hdsa`
      }
      if (!is.null(self$`ff`)) {
        TeamStatsSeasonObject[["ff"]] <-
          self$`ff`
      }
      if (!is.null(self$`fa`)) {
        TeamStatsSeasonObject[["fa"]] <-
          self$`fa`
      }
      if (!is.null(self$`ff_adj`)) {
        TeamStatsSeasonObject[["ff_adj"]] <-
          self$`ff_adj`
      }
      if (!is.null(self$`fa_adj`)) {
        TeamStatsSeasonObject[["fa_adj"]] <-
          self$`fa_adj`
      }
      if (!is.null(self$`hdff`)) {
        TeamStatsSeasonObject[["hdff"]] <-
          self$`hdff`
      }
      if (!is.null(self$`hdfa`)) {
        TeamStatsSeasonObject[["hdfa"]] <-
          self$`hdfa`
      }
      if (!is.null(self$`cf`)) {
        TeamStatsSeasonObject[["cf"]] <-
          self$`cf`
      }
      if (!is.null(self$`ca`)) {
        TeamStatsSeasonObject[["ca"]] <-
          self$`ca`
      }
      if (!is.null(self$`cf_adj`)) {
        TeamStatsSeasonObject[["cf_adj"]] <-
          self$`cf_adj`
      }
      if (!is.null(self$`ca_adj`)) {
        TeamStatsSeasonObject[["ca_adj"]] <-
          self$`ca_adj`
      }
      if (!is.null(self$`bsf`)) {
        TeamStatsSeasonObject[["bsf"]] <-
          self$`bsf`
      }
      if (!is.null(self$`bsa`)) {
        TeamStatsSeasonObject[["bsa"]] <-
          self$`bsa`
      }
      if (!is.null(self$`bsf_adj`)) {
        TeamStatsSeasonObject[["bsf_adj"]] <-
          self$`bsf_adj`
      }
      if (!is.null(self$`bsa_adj`)) {
        TeamStatsSeasonObject[["bsa_adj"]] <-
          self$`bsa_adj`
      }
      if (!is.null(self$`msf`)) {
        TeamStatsSeasonObject[["msf"]] <-
          self$`msf`
      }
      if (!is.null(self$`msa`)) {
        TeamStatsSeasonObject[["msa"]] <-
          self$`msa`
      }
      if (!is.null(self$`msf_adj`)) {
        TeamStatsSeasonObject[["msf_adj"]] <-
          self$`msf_adj`
      }
      if (!is.null(self$`msa_adj`)) {
        TeamStatsSeasonObject[["msa_adj"]] <-
          self$`msa_adj`
      }
      if (!is.null(self$`hdmsf`)) {
        TeamStatsSeasonObject[["hdmsf"]] <-
          self$`hdmsf`
      }
      if (!is.null(self$`hdmsa`)) {
        TeamStatsSeasonObject[["hdmsa"]] <-
          self$`hdmsa`
      }
      if (!is.null(self$`teammate_block`)) {
        TeamStatsSeasonObject[["teammate_block"]] <-
          self$`teammate_block`
      }
      if (!is.null(self$`teammate_block_adj`)) {
        TeamStatsSeasonObject[["teammate_block_adj"]] <-
          self$`teammate_block_adj`
      }
      if (!is.null(self$`hf`)) {
        TeamStatsSeasonObject[["hf"]] <-
          self$`hf`
      }
      if (!is.null(self$`ht`)) {
        TeamStatsSeasonObject[["ht"]] <-
          self$`ht`
      }
      if (!is.null(self$`ozf`)) {
        TeamStatsSeasonObject[["ozf"]] <-
          self$`ozf`
      }
      if (!is.null(self$`nzf`)) {
        TeamStatsSeasonObject[["nzf"]] <-
          self$`nzf`
      }
      if (!is.null(self$`dzf`)) {
        TeamStatsSeasonObject[["dzf"]] <-
          self$`dzf`
      }
      if (!is.null(self$`fow`)) {
        TeamStatsSeasonObject[["fow"]] <-
          self$`fow`
      }
      if (!is.null(self$`fol`)) {
        TeamStatsSeasonObject[["fol"]] <-
          self$`fol`
      }
      if (!is.null(self$`ozfw`)) {
        TeamStatsSeasonObject[["ozfw"]] <-
          self$`ozfw`
      }
      if (!is.null(self$`ozfl`)) {
        TeamStatsSeasonObject[["ozfl"]] <-
          self$`ozfl`
      }
      if (!is.null(self$`nzfw`)) {
        TeamStatsSeasonObject[["nzfw"]] <-
          self$`nzfw`
      }
      if (!is.null(self$`nzfl`)) {
        TeamStatsSeasonObject[["nzfl"]] <-
          self$`nzfl`
      }
      if (!is.null(self$`dzfw`)) {
        TeamStatsSeasonObject[["dzfw"]] <-
          self$`dzfw`
      }
      if (!is.null(self$`dzfl`)) {
        TeamStatsSeasonObject[["dzfl"]] <-
          self$`dzfl`
      }
      if (!is.null(self$`pent0`)) {
        TeamStatsSeasonObject[["pent0"]] <-
          self$`pent0`
      }
      if (!is.null(self$`pent2`)) {
        TeamStatsSeasonObject[["pent2"]] <-
          self$`pent2`
      }
      if (!is.null(self$`pent4`)) {
        TeamStatsSeasonObject[["pent4"]] <-
          self$`pent4`
      }
      if (!is.null(self$`pent5`)) {
        TeamStatsSeasonObject[["pent5"]] <-
          self$`pent5`
      }
      if (!is.null(self$`pent10`)) {
        TeamStatsSeasonObject[["pent10"]] <-
          self$`pent10`
      }
      if (!is.null(self$`pend0`)) {
        TeamStatsSeasonObject[["pend0"]] <-
          self$`pend0`
      }
      if (!is.null(self$`pend2`)) {
        TeamStatsSeasonObject[["pend2"]] <-
          self$`pend2`
      }
      if (!is.null(self$`pend4`)) {
        TeamStatsSeasonObject[["pend4"]] <-
          self$`pend4`
      }
      if (!is.null(self$`pend5`)) {
        TeamStatsSeasonObject[["pend5"]] <-
          self$`pend5`
      }
      if (!is.null(self$`pend10`)) {
        TeamStatsSeasonObject[["pend10"]] <-
          self$`pend10`
      }
      if (!is.null(self$`season`)) {
        TeamStatsSeasonObject[["season"]] <-
          self$`season`
      }
      if (!is.null(self$`session`)) {
        TeamStatsSeasonObject[["session"]] <-
          self$`session`
      }
      ...
      if (!is.null(self$`opp_team`)) {
        TeamStatsSeasonObject[["opp_team"]] <-
          self$`opp_team`
      }
      if (!is.null(self$`strength_state`)) {
        TeamStatsSeasonObject[["strength_state"]] <-
          self$`strength_state`
      }
      if (!is.null(self$`period`)) {
        TeamStatsSeasonObject[["period"]] <-
          self$`period`
      }
      if (!is.null(self$`score_state`)) {
        TeamStatsSeasonObject[["score_state"]] <-
          self$`score_state`
      }
      return(TeamStatsSeasonObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of TeamStatsSeason
    #'
    #' @param input_json the JSON input
    #' @return the instance of TeamStatsSeason
    ...
    #' @return TeamStatsSeason in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to TeamStatsSeason and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`toi`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TeamStatsSeason: the required field `toi` is missing."))
      }
      ...
      if (!is.null(input_json$`season`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TeamStatsSeason: the required field `season` is missing."))
      }
      ...
      if (!is.null(input_json$`session`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TeamStatsSeason: the required field `session` is missing."))
      }
      ...
      if (!is.null(input_json$`team`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TeamStatsSeason: the required field `team` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of TeamStatsSeason
    toString = function() {
      self$toJSONString()
    },
...
# TeamStatsSeason$unlock()
#
## Below is an example to define the print function
# TeamStatsSeason$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# TeamStatsSeason$lock()
