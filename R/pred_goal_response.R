#' Create a new PredGoalResponse
#'
#' @description
#' PredGoalResponse Class
#'
#' @docType class
#' @title PredGoalResponse
#' @description PredGoalResponse Class
...
#' @field data  list(\link{PredGoalRow})
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PredGoalResponse <- R6::R6Class(
  "PredGoalResponse",
  public = list(
    `count` = NULL,
    `total` = NULL,
    ...
    #' @description
    #' Initialize a new PredGoalResponse class.
    #'
    #' @param count count
    #' @param total total
    #' @param limit limit
    ...
    #'
    #' @return PredGoalResponse as a base R list.
    #' @examples
    #' # convert array of PredGoalResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PredGoalResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PredGoalResponseObject <- list()
      if (!is.null(self$`count`)) {
        PredGoalResponseObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`total`)) {
        PredGoalResponseObject[["total"]] <-
          self$`total`
      }
      if (!is.null(self$`limit`)) {
        PredGoalResponseObject[["limit"]] <-
          self$`limit`
      }
      if (!is.null(self$`offset`)) {
        PredGoalResponseObject[["offset"]] <-
          self$`offset`
      }
      if (!is.null(self$`has_next`)) {
        PredGoalResponseObject[["has_next"]] <-
          self$`has_next`
      }
      if (!is.null(self$`data`)) {
        PredGoalResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      return(PredGoalResponseObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of PredGoalResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of PredGoalResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[PredGoalRow]", loadNamespace("chickenstats.api"))
      }
      self
    },
    ...
    #' @return PredGoalResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PredGoalResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`count`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PredGoalResponse: the required field `count` is missing."))
      }
      ...
      if (!is.null(input_json$`total`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PredGoalResponse: the required field `total` is missing."))
      }
      ...
      if (!is.null(input_json$`limit`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PredGoalResponse: the required field `limit` is missing."))
      }
      ...
      if (!is.null(input_json$`offset`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PredGoalResponse: the required field `offset` is missing."))
      }
      ...
      if (!is.null(input_json$`has_next`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PredGoalResponse: the required field `has_next` is missing."))
      }
      ...
      if (!is.null(input_json$`data`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PredGoalResponse: the required field `data` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of PredGoalResponse
    toString = function() {
      self$toJSONString()
    },
...
# PredGoalResponse$unlock()
#
## Below is an example to define the print function
# PredGoalResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PredGoalResponse$lock()
