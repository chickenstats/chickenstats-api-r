...
PlayByPlayApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param play_id (optional) No description
    ...
    #'
    #' @return PbpResponse
    ReadPbp = function(season = NULL, sessions = NULL, game_id = NULL, play_id = NULL, event = NULL, player_1 = NULL, goalie = NULL, event_team = NULL, opp_team = NULL, strength_state = NULL, include = NULL, limit = 10000, offset = 0, data_file = NULL, ...) {
      local_var_response <- self$ReadPbpWithHttpInfo(season, sessions, game_id, play_id, event, player_1, goalie, event_team, opp_team, strength_state, include, limit, offset, data_file = data_file, ...)
    ...
    ReadPbpWithHttpInfo = function(season = NULL, sessions = NULL, game_id = NULL, play_id = NULL, event = NULL, player_1 = NULL, goalie = NULL, event_team = NULL, opp_team = NULL, strength_state = NULL, include = NULL, limit = 10000, offset = 0, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      # explore
      for (query_item in `play_id`) {
        query_params[["play_id"]] <- c(query_params[["play_id"]], list(`play_id` = query_item))
      }
      ...
      for (query_item in `include`) {
        ...
        if (!is.null(query_item) && !(query_item %in% c("player", "game"))) {
          stop("Invalid value for include when calling PlayByPlayApi$ReadPbp. Must be [player, game].")
        }
