#' Create a new StandingsResponse
#'
#' @description
...
#' @description StandingsResponse Class
...
#' @field data  list(\link{StandingsPublic})
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
StandingsResponse <- R6::R6Class(
  "StandingsResponse",
  public = list(
    `count` = NULL,
    `total` = NULL,
    ...
    #' @description
    #' Initialize a new StandingsResponse class.
    #'
    #' @param count count
    #' @param total total
    #' @param limit limit
    ...
    #'
    #' @return StandingsResponse as a base R list.
    #' @examples
    #' # convert array of StandingsResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert StandingsResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      StandingsResponseObject <- list()
      if (!is.null(self$`count`)) {
        StandingsResponseObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`total`)) {
        StandingsResponseObject[["total"]] <-
          self$`total`
      }
      if (!is.null(self$`limit`)) {
        StandingsResponseObject[["limit"]] <-
          self$`limit`
      }
      if (!is.null(self$`offset`)) {
        StandingsResponseObject[["offset"]] <-
          self$`offset`
      }
      if (!is.null(self$`has_next`)) {
        StandingsResponseObject[["has_next"]] <-
          self$`has_next`
      }
      if (!is.null(self$`data`)) {
        StandingsResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      return(StandingsResponseObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of StandingsResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of StandingsResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[StandingsPublic]", loadNamespace("chickenstats.api"))
      }
      self
    },
    ...
    #' @return StandingsResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to StandingsResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`count`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for StandingsResponse: the required field `count` is missing."))
      }
      ...
      if (!is.null(input_json$`total`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for StandingsResponse: the required field `total` is missing."))
      }
      ...
      if (!is.null(input_json$`limit`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for StandingsResponse: the required field `limit` is missing."))
      }
      ...
      if (!is.null(input_json$`offset`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for StandingsResponse: the required field `offset` is missing."))
      }
      ...
      if (!is.null(input_json$`has_next`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for StandingsResponse: the required field `has_next` is missing."))
      }
      ...
      if (!is.null(input_json$`data`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for StandingsResponse: the required field `data` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of StandingsResponse
    toString = function() {
      self$toJSONString()
    },
...
# StandingsResponse$unlock()
#
## Below is an example to define the print function
# StandingsResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# StandingsResponse$lock()
