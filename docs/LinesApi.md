...
[**ReadLinesLineIds**](LinesApi.md#ReadLinesLineIds) | **GET** /api/v1/chicken_nhl/lines/line_ids | Read Lines Line Ids
[**ReadSeasonLines**](LinesApi.md#ReadSeasonLines) | **GET** /api/v1/chicken_nhl/lines/season | Read Season Lines


# **ReadGameLines**
> LinesGameResponse ReadGameLines(season = var.season, sessions = var.sessions, game_id = var.game_id, team = var.team, opp_team = var.opp_team, strength_state = var.strength_state, score_state = var.score_state, level = var.level, linemates = var.linemates, opposition = var.opposition, include = var.include, limit = 10000, offset = 0)
